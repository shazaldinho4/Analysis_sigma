...
public:
    ...
    float getECPB_ECtot(int ip){return loc_ECPB_ECtot->at(ip);}
    float getECPB_ECinn(int ip){return loc_ECPB_ECinn->at(ip);}
    float getECPB_ECout(int ip){return loc_ECPB_ECout->at(ip);}
    float getECPB_X(int ip){return loc_ECPB_X->at(ip);}
    float getECPB_Y(int ip){return loc_ECPB_Y->at(ip);}
    float getECPB_Z(int ip){return loc_ECPB_Z->at(ip);}
    float getECPB_time(int ip){return loc_ECPB_time->at(ip);}
    float getECPB_path(int ip){return loc_ECPB_path->at(0);} //This skim only has one path saved from the neutral track
    ...
    int getNum_tracks(){return loc_EVNT_track->size();} //number of charged
    ...
    int getEntries();
    float getECPB_pathcorr(int ip);
    float getECPB_betacorr(int ip);
